module Api
  module V1
    class LikesController < ApplicationController
      ...
      def create
        if already_liked?
          render json: { message: 'Already liked.', post: @post, likes: @post.likes.count }, status: :unprocessable_entity
        else
      ...
      def destroy
        if already_liked?
          ...
          render json: { message: 'Cannot unlike', post: @post, likes: @post.likes.count }, status: :unprocessable_entity
        end
      end
